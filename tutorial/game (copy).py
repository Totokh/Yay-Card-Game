...
class Character(Actor):
  ...
  def __init__(self, name, hp, max_hp, attack, defense, mana, level, xp, gold,
...
class GiantSpider(Enemy):
  ...
  def __init__(self):
    super().__init__("🕷️ Giant Spider", 3, 2, 1, 1,
                     2)  # HP, attack, defense, XP, gold
...
class Crocodile(Enemy):
  ...
  def __init__(self):
    super().__init__("🐊 Crocodile", 5, 3, 1, 2,
                     2)  # HP, attack, defense, XP, gold
...
class Poodle(Enemy):
  ...
  def __init__(self):
    super().__init__("🐩 Poodle", 7, 4, 1, 3,
                     3)  # HP, attack, defense, XP, gold
...
class Dragon(Enemy):
  ...
  def __init__(self):
    super().__init__("🐉 Dragon", 10, 6, 2, 5,
                     5)  # HP, attack, defense, XP, gold
